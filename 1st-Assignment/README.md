...
2. **Run** [test-res1.sh](src/test-res1.sh) script which will compile and execute the program with 2 parameters, 100 (total number of orders) and 1000 (for the initial seed).
