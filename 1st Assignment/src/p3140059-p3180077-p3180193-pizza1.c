#include "p3140059-p3180077-p3180193-pizza1.h"
...
void* order(void * x){
	...
	//locking the oven_lock again
	//to make changes now the order
	//is done
	...
	//the oven that was busy with the specific order
	//is now available
	...
	//time_lock to calculate the time
	//with gettime function
